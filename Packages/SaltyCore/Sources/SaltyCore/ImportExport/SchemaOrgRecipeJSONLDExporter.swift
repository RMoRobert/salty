...
public struct SchemaOrgRecipeJSONLDExporter {

    /// Stateless; exposes the synthesised init to callers outside SaltyCore.
    public init() {}
    ...
    public struct LibraryMetadata {
        ...
        public init(courseName: String? = nil, categoryNames: [String] = [], tagNames: [String] = []) {
    ...
    public func jsonObject(for recipe: Recipe, metadata: LibraryMetadata = LibraryMetadata()) -> [String: Any] {
        var dict: [String: Any] = [
    ...
    public func data(for recipe: Recipe, metadata: LibraryMetadata = LibraryMetadata()) throws -> Data {
    ...
    public func data(for recipes: [(recipe: Recipe, metadata: LibraryMetadata)]) throws -> Data {
