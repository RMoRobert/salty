...
public struct MacGourmetImportRecipe: Decodable, Sendable {
    ...
    public var categories: [MGCategory]?
    public var directions: [MGDirection]?
    public var ingredients: [MGIngredient]?
    public var notes: [MGNote]?
    ...
    public var prepTimes: [MGPrepTime]?
    public var publicationPage: String?
    ...
    public struct MGDirection: Decodable, Sendable {
    ...
    public struct MGIngredient: Decodable, Sendable {
    ...
    public struct MGPrepTime: Decodable, Sendable {
        var amount = 0
        var amount2 = 0
        var timeTypeID = 0
        var timeUnitId = 0
    ...
    public struct MGNote: Decodable, Sendable {
        var noteText = ""
        var noteType = 0
    ...
    public struct MGCategory: Decodable, Sendable {
        var name: String
