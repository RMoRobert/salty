...
public enum IngredientScaler {
    ...
    public struct DisplayParts: Equatable {
        public var quantity: String
        public var remainder: String
        
        public var hasQuantity: Bool { !quantity.isEmpty }
    }
    
    /// Returns quantity/remainder for display. At `scaleFactor` 1, preserves original formatting via `parseQuantity()`.
    public static func displayParts(for ingredient: Ingredient, scaleFactor: Double) -> DisplayParts {
    ...
    public static func scaledText(for ingredient: Ingredient, scaleFactor: Double) -> String {
    ...
    public static func scaleQuantityString(_ quantity: String, factor: Double) -> String? {
    ...
    public static func parseNumberToken(_ token: String) -> Double? {
    ...
    public static func formatScaledAmount(_ value: Double, preferFraction: Bool = true) -> String {
