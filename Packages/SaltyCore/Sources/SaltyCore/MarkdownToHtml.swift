...
public enum MarkdownToHtml {
    ...
    public static func document(markdown: String) -> String {
        """
        <!DOCTYPE html>
        <html>
        <head>
    ...
    public static func bodyHTML(markdown: String) -> String {
    ...
    public static let contentSecurityPolicy = "default-src 'none'; style-src 'unsafe-inline'; img-src data:;"
