...
public struct DirectionTextParser {
    ...
    public static func parseDirections(from text: String) -> [Direction] {
    ...
    public static func formatDirections(_ directions: [Direction]) -> String {
        var lines: [String] = []
    ...
    public static func parseDirectionsSimple(from text: String) -> [Direction] {
        let lines = text.components(separatedBy: .newlines)
        var directions: [Direction] = []
    ...
    public static func parseDirectionsSimpleWithCleanup(from text: String) -> [Direction] {
