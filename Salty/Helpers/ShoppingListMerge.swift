...
enum ShoppingListMerge {

    struct Resolution {
        let merged: ServerShoppingList
        ...
        let conflictCopy: ServerShoppingList?

        init(merged: ServerShoppingList, conflictCopy: ServerShoppingList? = nil) {
            self.merged = merged
