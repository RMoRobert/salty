...
/// runs automatically.
enum ShoppingListFreeformConverter {
    ...
    static func text(from items: [ShoppingListListContents]) -> String {
        items.map { item in
    ...
    static func items(from text: String) -> [ShoppingListListContents] {
