...
struct RecipeLibraryNames {
    var course: String?
    var categories: [String]
    var tags: [String]

    static let empty = RecipeLibraryNames(course: nil, categories: [], tags: [])
}
...
extension Recipe {
    ...
    func libraryNames(database: any DatabaseReader) -> RecipeLibraryNames {
        let recipeId = id
